...
# Save metrics
write.csv(metrics, "data/sirs_fit_metrics_v1.csv", row.names = FALSE)
...
png("sirs_scenarios_vs_observed_v1.png", width = 1400, height = 1100, res = 100)
...
dev.off()
cat("  Saved: sirs_scenarios_vs_observed_v1.png\n")

# Plot 2: Best fits comparison
png("sirs_best_fits_v1.png", width = 1400, height = 700, res = 100)
par(mar = c(5, 5, 4, 2))
...
dev.off()
cat("  Saved: sirs_best_fits_v1.png\n")
...
cat(paste(rep("=", 60), collapse = ""), "\n")
cat("\nOutput files:\n")
cat("  - sirs_scenarios_vs_observed_v1.png (all scenarios)\n")
cat("  - sirs_best_fits_v1.png (top 3 best-fitting scenarios)\n")
cat("  - data/sirs_fit_metrics_v1.csv (fit statistics)\n")